...
#     chooise = input('您想怎么回家？')
    ...
    #     if raodao == '游戏厅':
    #         print(dic["C"]["绕道回家"]["Cy"]+"还是想想清楚再选择吧！")
    #         continue
    #     elif raodao == '网吧':
    #         print(dic["C"]["绕道回家"]["Cb"]+"还是想想清楚再选择吧！")
    #         continue
...
# 方法二：
# for i in li:
    # print((i.strip().startswith('A') or i.strip().startswith('a')) and i.strip().endswith('c'))
